...
from .utils import intersection_over_union, unique
    ...
    for idx in range(batch_size):
        ...
        for cls in img_classes:
            ...
            for i in range(index):
                try:
                    ious = intersection_over_union(image_pred_class[i].unsqueeze(0), image_pred_class[i + 1:])
                except ValueError:
                    break
                except IndexError:
                    break
